...
import com.mxi.buildsterapp.activity.ReassignActivity;
...
public class TradeworkerClickActionItemAdapter extends RecyclerView.Adapter<TradeworkerClickActionItemAdapter.ViewHolder> {
...
//    Activity activity;
    ...
    public TradeworkerClickActionItemAdapter(List<ActionItemData> screen_list, int rowLayout, Context context) {
...
//        activity = (Activity) mContext;
    ...
    public void onBindViewHolder(final ViewHolder viewHolder, int i) {
        ...
        if (aItem.getTradeworker_id().equals(cc.loadPrefString("user_id"))){
...
//            cc.savePrefString("action_screen_name",aData.getFloor_title());
            cc.savePrefString("action_screen_id",aData.getFloor_id());
            cc.savePrefString("action_def_id",aData.getId());
            cc.savePrefString("action_tradeworker_id",aData.getTradeworker_id());
            cc.savePrefString("action_location",aData.getLocation());
            cc.savePrefString("action_date",aData.getCreated_datetime());
...
//            Intent intentViewMyProject = new Intent(mContext, ReassignActivity.class);
