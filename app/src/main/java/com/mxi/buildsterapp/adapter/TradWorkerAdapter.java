...
import com.mxi.buildsterapp.activity.ProjectProfileColor;
...
//    Activity activity;
    ...
    public TradWorkerAdapter(List<TradWorkerData> workerList, Context contextt) {
    ...
    public void onBindViewHolder(final MyViewHolder holder, final int position) {
        ...
        if (td.getIdAdd().equals("000")){
            ...
            if (td.getIsSettingProfile().equals("no")){
                ...
                Glide.with(context).load(R.drawable.plus).listener(new RequestListener<Integer, GlideDrawable>() {
                    @Override
                ...
                holder.iv_worker_pic.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        Intent intentInvite = new Intent(context, InviteTradeworkerTwo.class);
