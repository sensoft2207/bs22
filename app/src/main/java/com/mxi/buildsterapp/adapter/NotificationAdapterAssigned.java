...
public class NotificationAdapterAssigned extends RecyclerView.Adapter<NotificationAdapterAssigned.ViewHolder> {
    ...
    public NotificationAdapterAssigned(List<NotificationData> notification_list, int rowLayout, Context context) {
    ...
    private void getActionItemID(int adapterPosition) {
        ...
        if (!cc.isConnectingToInternet()) {
            ...
            cc.savePrefString("action_a_screen_id",aData.getNotification_id());
            cc.savePrefString("action_a_def_id",aData.getDef_id());
            cc.savePrefString("to_id_type","assign");
            cc.savePrefString("to_id",aData.getSender_id());
            cc.savePrefString("title",aData.getTitle());
