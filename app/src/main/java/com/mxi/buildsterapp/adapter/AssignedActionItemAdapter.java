...
import com.mxi.buildsterapp.activity.AssignedProjectActionItem;
import com.mxi.buildsterapp.activity.AssignedProjectActionItemUpdate;
import com.mxi.buildsterapp.activity.MyProjectActionItemDetail;
...
public class AssignedActionItemAdapter extends RecyclerView.Adapter<AssignedActionItemAdapter.ViewHolder> {
...
//    Activity activity;
    ...
    public AssignedActionItemAdapter(List<ActionItemData> screen_list, int rowLayout, Context context) {
...
//        activity = (Activity) mContext;
    ...
    public void onBindViewHolder(final ViewHolder viewHolder, int i) {
       ...
       // Glide.with(mContext).load(R.drawable.student).into(viewHolder.iv_worker_pic);
        ...
        if (aItem.getStatus_item().equals("approve")){
            ...
            viewHolder.ln_approvall_thumb.setVisibility(View.VISIBLE);
            viewHolder.ln_blue_item_circle.setVisibility(View.GONE);
            viewHolder.ln_green_item_circle.setVisibility(View.GONE);
            ...
            viewHolder.ln_approvall_thumb.setVisibility(View.GONE);
        }

        if (aItem.getViewed().equals("0")){

            viewHolder.ln_viewed_task.setVisibility(View.VISIBLE);

        }else {

            viewHolder.ln_viewed_task.setVisibility(View.GONE);
        }
    ...
    private void getActionItemID(int adapterPosition) {
        ...
        if (!cc.isConnectingToInternet()){
            ...
            cc.savePrefString("action_a_screen_name",aData.getFloor_title());
            ...
            cc.savePrefString("action_a_created_by",aData.getCreated_by());
            cc.savePrefString("action_a_date",aData.getCreated_datetime());
            cc.savePrefString("action_profileimg2",aData.getProfile_img());
            ...
            cc.savePrefString("action_a_tradeworker_name",aData.getFirstname()+" "+aData.getLastname());
...
//            activity.overridePendingTransition(R.anim.slide_from_right, R.anim.slide_to_left);
    ...
    public static class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public LinearLayout header_click,ln_approvall_thumb,ln_message_read,ln_accepted_task,ln_viewed_task;
        ...
        public ViewHolder(View itemView) {
            ...
            ln_approvall_thumb = (LinearLayout) itemView.findViewById(R.id.ln_approvall_thumb);
            ...
            ln_viewed_task = (LinearLayout) itemView.findViewById(R.id.ln_viewed_task);
