...
public class TradeworkerClickActionItem extends AppCompatActivity implements SwipeRefreshLayout.OnRefreshListener {
    ...
    TradeworkerClickActionItemAdapter slAdapter;
    ...
    private void clickListner() {
        ...
        ln_send_message.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intentViewMyProject = new Intent(TradeworkerClickActionItem.this, ChatActivity.class);
                    ...
                    public void onResponse(String response) {
                        ...
                        try {
                            ...
                            if (jsonObject.getString("status").equals("200")) {
                                ...
                                slAdapter = new TradeworkerClickActionItemAdapter(action_item_list, R.layout.rc_action_item, getApplicationContext());
