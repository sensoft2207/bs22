...
import com.mxi.buildsterapp.chiptext.ContactsCompletionView;
import com.mxi.buildsterapp.chiptext.FilterAdapter;
...
public class InviteTradeworkerTwo extends AppCompatActivity implements TokenCompleteTextView.TokenListener<MessageData>{
...
//        ed_multiple_email = (AutoCompleteTextView) findViewById(R.id.ed_multiple_email);
        ...
        if (!cc.isConnectingToInternet()) {
            ...
            AndyUtils.showToast(InviteTradeworkerTwo.this, getString(R.string.no_internet));
...
*/
    ...
    private void getRegisteredList() {
        ...
        progressDialog = new ProgressDialog(InviteTradeworkerTwo.this);
                    ...
                    public void onResponse(String response) {
                        ...
                        try {
                            ...
                            if (jsonObject.getString("status").equals("200")) {
                                ...
                                filterAdapter = new FilterAdapter(getApplicationContext(), R.layout.country_list_rv_item, registered_user_list);
...
*/
    ...
    private void inviteTradeworkerVali() {
      ...
      /*  List<MessageData> tokens = autoCompleteTextView.getObjects();
        StringBuilder content = new StringBuilder();
        for (int i = 0; i < tokens.size(); i++) {

            MessageData md = tokens.get(i);


            Log.e("MultipleEmail",md.getName());
        }*/
        to_email = autoCompleteTextView.getText().toString();
        ...
        StringRequest jsonObjReq = new StringRequest(Request.Method.POST, Const.ServiceType.INVITE_TRADEWORKER,
            ...
            protected Map<String, String> getParams() throws AuthFailureError {
                ...
                for (int i = 0; i < tokens.size(); i++) {
                    ...
                    String to_email = md.getName();

                    params.put("to_email[" + i + "]",to_email);

                    Log.e("to_email[" + i + "]", to_email);
    ...
    @Override
    public void onTokenAdded(MessageData token) {
        Log.e("Main", "A Token added");
    }

    @Override
    public void onTokenRemoved(MessageData token) {
        Log.e("Main", "A Token removed");
    }
}
