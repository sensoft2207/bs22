package com.mxi.buildsterapp.dragevent;
...
/**
 * Created by vishal on 17/5/18.
 */

public class DragLayerTwo extends MyAbsoluteLayout
     ...
     */
    public DragLayerTwo(Context context, AttributeSet attrs) {
        super(context, attrs);
    }
