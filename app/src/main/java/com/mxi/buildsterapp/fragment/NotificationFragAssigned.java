...
import com.mxi.buildsterapp.adapter.NotificationAdapterAssigned;
...
public class NotificationFragAssigned extends Fragment implements SwipeRefreshLayout.OnRefreshListener {
    ...
    NotificationAdapterAssigned mAdapter;
                    ...
                    public void onResponse(String response) {
                        ...
                        try {
                            ...
                            if (jsonObject.getString("status").equals("200")) {
                                ...
                                mAdapter = new NotificationAdapterAssigned(notification_list, R.layout.rc_notification_item, getContext());
